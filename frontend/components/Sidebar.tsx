      ...
      <div className="space-y-6">
        ...
        <div className="pt-4 border-t border-slate-200/80 dark:border-slate-800/80 space-y-2.5">
          <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 flex items-center justify-between font-mono">
            <span className="flex items-center gap-1.5">
              <Cpu className="w-3.5 h-3.5 text-electric-400" /> Mode Selection
            </span>
            <span className="text-[10px] text-electric-400 font-bold uppercase">{mode === 'rag' ? 'RAG Active' : 'AI Active'}</span>
          </h3>
        ...
        <div className="pt-4 border-t border-slate-200/80 dark:border-slate-800/80 space-y-2 text-xs">
          ...
          <div className="flex justify-between py-1.5 px-3 rounded-xl bg-slate-100/60 dark:bg-slate-900/60 text-slate-600 dark:text-slate-400 border border-slate-200/40 dark:border-slate-800/40">
            ...
            <span className={`font-semibold flex items-center gap-1 ${apiStatus ? 'text-emeraldAccent-400' : 'text-amberAccent-400'}`}>
              <span className={`w-2 h-2 rounded-full ${apiStatus ? 'bg-emeraldAccent-400 animate-ping' : 'bg-amberAccent-400'}`} />
              {apiStatus ? 'API Online' : 'Client Mode'}
            </span>
          </div>
        </div>
      </div>
